$(document).ready(function() {
  function formPostData(url, fields) {
    var form = $(
      '<form style="display: none;" method="post" action="' + url + '"></form>'
    );
    ...
    ctrl.open = function() {
      ...
      ctrl.example.files = [
        ...
        },
        {
          ...
          url:
            "https://raw.githubusercontent.com/silviomoreto/bootstrap-select/master/dist/js/bootstrap-select.js",
          content: ""
        },
        {
          name: "bootstrap-select.css",
          url:
            "https://raw.githubusercontent.com/silviomoreto/bootstrap-select/master/dist/css/bootstrap-select.css",
          content: ""
        }
      ];
